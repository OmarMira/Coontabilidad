...
export const Dashboard: React.FC<DashboardProps> = ({ stats, onNavigate, invoices = [], bills = [] }) => {
  ...
  return (
    <div className="space-y-10 animate-fade-in">
      {/* --- SECCI├ôN 1: MONITOR DE CUMPLIMIENTO (RADAR) --- */}
              ...
              <div className="space-y-10">
                ...
                <div className="relative">
                  <div className="flex justify-between items-end mb-3">
                    ...
                    <span className={`badge-elite ${sunbizDaysLeft < 30 ? 'bg-rose-500/20 text-rose-400' : 'bg-white/5 text-gray-400'}`}>
                      {sunbizDaysLeft} D├ìAS RESTANTES
                    </span>
                  </div>
                ...
                <div className="relative bg-white/5 p-5 rounded-2xl border border-white/5 hover:border-emerald-500/30 transition-all duration-500">
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <span className="block text-[10px] uppercase text-gray-500 font-black tracking-widest mb-1">Pr├│ximo Vencimiento DR-15</span>
      ...
      {/* --- SECCI├ôN 3: AN├üLISIS DE TENDENCIAS (CHARTS) --- */}
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 pb-10">

        {/* Gr├ífico de Barras: Ventas vs Compras */}
        ...
        {/* Acciones R├ípidas (Lateral) */}
        <div className="card-elite">
          <h3 className="text-xs font-black text-slate-500 uppercase tracking-[0.2em] mb-8">Accesos R├ípidos</h3>
          ...
          <div className="mt-8 p-6 bg-blue-600/5 rounded-3xl border border-blue-600/10 text-center">
            ...
            <p className="text-[10px] text-slate-500 leading-relaxed uppercase font-black">Tu IA est├í analizando los datos actuales...</p>
          </div>
        </div>
