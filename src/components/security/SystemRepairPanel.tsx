            ...
            <div className="max-w-4xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="p-6 bg-gray-50 border-t flex gap-3">
                    ...
                    <button
                        onClick={onRetry}
                        disabled={repairing}
                        className="px-6 py-3 bg-gray-600 text-white rounded-lg font-bold hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-colors"
                    >
                ...
                {/* Footer Info */}
                <div className="px-6 py-3 bg-gray-100 text-xs text-gray-600 text-center">
