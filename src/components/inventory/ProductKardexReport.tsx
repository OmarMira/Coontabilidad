    ...
    return (
        <div className="bg-white text-black p-8 max-w-4xl mx-auto shadow-2xl rounded-lg my-8">
            <div className="flex justify-between items-start border-b-2 border-slate-800 pb-4 mb-6">
                <div>
                    <h1 className="text-2xl font-bold uppercase tracking-wider">Kardex Físico Valorado</h1>
                    <p className="text-sm text-gray-500">Reporte de Movimientos de Inventario</p>
                </div>
            ...
            <div className="grid grid-cols-2 gap-8 mb-8 bg-gray-50 p-4 rounded border border-gray-200">
                <div>
                    ...
                    <div className="text-sm font-mono text-gray-600">SKU: {product.sku}</div>
                </div>
                <div className="text-right">
                    <label className="text-xs font-bold text-gray-400 uppercase">Existencia Actual</label>
                    <div className="text-2xl font-bold text-blue-600">{product.stock_quantity}</div>
                    <div className="text-xs text-gray-500">Método de Valuación: PROMEDIO</div>
                </div>
            </div>
                        ...
                        movements.map((m, idx) => (
                            <tr key={idx} className="border-b border-gray-200 hover:bg-gray-50">
                                ...
                                <td className="py-2">
                                    ...
                                    <br />
                                    <span className="text-xs text-gray-500 font-mono">{m.reference_type} #{m.reference_id}</span>
                                </td>
