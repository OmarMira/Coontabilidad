    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="bg-emerald-600/10 border-l-4 border-emerald-500 rounded-xl p-5 flex items-start gap-4 shadow-lg shadow-emerald-950/20">
        ...
        <p className="text-sm font-bold text-emerald-200/80 leading-relaxed">
          <span className="text-white font-bold tracking-tight mr-2">{t('accounting.closure.steps.reconciliation.phaseTitle')}:</span>
      ...
      <div className="bg-slate-900/50 rounded-2xl p-6 border border-slate-800 shadow-inner group">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h5 className="text-xs font-bold text-slate-500 uppercase tracking-wider group-hover:text-slate-300 transition-colors">{t('accounting.closure.steps.reconciliation.protocolTitle')}</h5>
        </div>
