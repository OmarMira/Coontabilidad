    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="bg-blue-600/10 border-l-4 border-blue-500 rounded-xl p-5 flex items-start gap-4">
        ...
        <p className="text-sm font-bold text-blue-200/80 leading-relaxed">
          <span className="text-white font-black uppercase tracking-tighter mr-2">{t('accounting.closure.steps.trialBalance.phaseTitle')}:</span>
      ...
      <div className="bg-slate-900/50 rounded-2xl border border-slate-800 overflow-hidden shadow-2xl">
        <div className="bg-slate-950/50 px-6 py-4 border-b border-slate-800 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <h5 className="text-[10px] font-black text-slate-500 uppercase tracking-widest">{t('accounting.closure.steps.trialBalance.preview')}</h5>
          </div>
          <button
            ...
            <table className="w-full text-sm">
              ...
              <tfoot className="bg-slate-950/40">
                <tr className="font-black text-white border-t-2 border-slate-700">
                  <td className="py-5 px-6 uppercase tracking-widest text-[10px] text-slate-500">{t('accounting.closure.steps.trialBalance.periodTotals')}</td>
      ...
      <div className="bg-slate-900/50 rounded-2xl p-6 border border-slate-800 shadow-inner group">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h5 className="text-[10px] font-black text-slate-500 uppercase tracking-widest group-hover:text-slate-300 transition-colors">{t('accounting.closure.steps.trialBalance.controlPoints')}</h5>
        </div>
