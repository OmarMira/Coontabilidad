        ...
        <div className="space-y-10 animate-in fade-in duration-500">
            ...
            <div className="relative">
                <div className="absolute -top-6 left-8 flex items-center gap-2 no-print">
                    <span className="text-[8px] font-black text-slate-600 uppercase tracking-widest">Contabilidad</span>
                    <ChevronRight className="w-2.5 h-2.5 text-slate-800" />
                    <span className="text-[8px] font-black text-blue-500 uppercase tracking-widest">Estados Financieros</span>
                    <ChevronRight className="w-2.5 h-2.5 text-slate-800" />
                    <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">
                        {view === 'balance' ? 'Balance General' : 'P&L / Resultados'}
                    </span>
                </div>
