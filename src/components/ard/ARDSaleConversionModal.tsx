...
export const ARDSaleConversionModal: React.FC<ARDSaleConversionModalProps> = ({ document, onClose, onSuccess }) => {
    ...
    const [description, setDescription] = useState(t('ard.sale.autoGeneratedDesc', { docName: document.name, vendor: analysis.vendor || 'Proveedor/Vendedor no identificado' }));
