        ...
        <div className="space-y-10 animate-fade-in px-2">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    ...
                    <p className="text-gray-400 mt-2 font-medium">Análisis profundo, cumplimiento oficial y exportación unificada.</p>
                </div>
            </div>
                                    ...
                                    <div>
                                        <div className="flex justify-between items-start mb-6">
                                            <div className="p-3 bg-white/5 rounded-2xl group-hover:bg-blue-500/10 transition-colors">
                                                <report.icon className="w-6 h-6 text-gray-400 group-hover:text-blue-400 transition-colors" />
                                            </div>
                                            {report.isNew && (
            ...
            <div className="p-8 border border-white/5 bg-white/5 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500">Todos los reportes están optimizados para auditorías estatales y federales.</p>
                    </div>
                </div>
                <div className="text-[10px] font-black text-gray-500 uppercase tracking-widest text-center md:text-right">
