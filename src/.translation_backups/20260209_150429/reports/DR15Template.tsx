        ...
        <div className="relative p-8 bg-white text-black font-mono text-sm max-w-[210mm] mx-auto border border-gray-300 shadow-lg min-h-[297mm]">
            ...
            <div className="border-b-4 border-black pb-4 mb-6 flex justify-between items-start mt-8">
                <div>
                    ...
                    <h2 className="text-lg text-slate-700">Declaración de Impuestos sobre Ventas y Uso</h2>
                </div>
                <div className="text-right">
                    <div className="bg-gray-100 p-2 rounded border border-gray-300">
                        <p className="text-xs text-slate-600 uppercase">Período de Recaudación</p>
            ...
            <div className="mb-8 grid grid-cols-2 gap-4">
                <div className="border p-2">
                    <p className="text-xs text-slate-600">Número de Certificado</p>
            ...
            <div className="mt-auto pt-8 border-t-2 border-black text-xs text-slate-600">
                ...
                <p className="mt-2 text-center font-bold text-slate-500">SÓLO PARA USO OFICIAL - NO ENVIAR POR CORREO</p>
            </div>
        </div>
    );
};
