      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white/10 rounded-lg p-6 border border-white/10">
          ...
          <div className="space-y-3">
            <div>
              <p className="text-slate-500 text-sm">Nombre del Proveedor</p>
        ...
        <div className="bg-white/10 rounded-lg p-6 border border-white/10">
          ...
          <div className="space-y-3">
            <div>
              <p className="text-slate-500 text-sm">Número de Factura</p>
            ...
            <div>
              <p className="text-slate-500 text-sm">Creada</p>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-slate-900">
              <tr>
                <th className="text-left p-4 text-slate-400 font-medium">Descripción</th>
                <th className="text-right p-4 text-slate-400 font-medium">Cantidad</th>
                <th className="text-right p-4 text-slate-400 font-medium">Precio Unitario</th>
                <th className="text-center p-4 text-slate-400 font-medium">Gravable</th>
                <th className="text-right p-4 text-slate-400 font-medium">Total Línea</th>
              </tr>
            </thead>
