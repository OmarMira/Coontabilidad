                ...
                <CardContent className="space-y-4">
                    ...
                    >
                        ...
                        <div className="text-left">
                            ...
                            <span className="text-xs text-slate-500 font-normal">Descargar copia cifrada de la base de datos</span>
                        </div>
                    </Button>
                    <Button
                    ...
                    >
                        ...
                        <div className="text-left">
                            ...
                            <span className="text-xs text-slate-500 font-normal">Importar y reemplazar datos desde un archivo</span>
                        </div>
                    </Button>
                </CardContent>
            </Card>
                    ...
                    {status === 'success' ? (
                        ...
                        <>
                            <div className="space-y-2">
                                <label className="text-sm text-slate-500">Contraseña de Cifrado (Opcional)</label>
                    ...
                    {status === 'success' ? (
                        ...
                        <>
                            <div className="border-2 border-dashed border-white/10 rounded-lg p-8 text-center bg-white/10/50">
                                ...
                                <p className="text-sm text-slate-500">Arrastre su archivo .enc aquí o haga clic para seleccionar</p>
