            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="card-elite bg-gradient-to-br from-indigo-600/20 to-transparent border-indigo-500/20 !p-8 relative overflow-hidden">
                    <div className="relative z-10">
                        ...
                        <p className="text-slate-600 text-xs mt-2 font-medium">Monto detectado en documentos procesados esperando cobro.</p>
                    </div>
                ...
                <div className="card-elite bg-gradient-to-br from-emerald-600/20 to-transparent border-emerald-500/20 !p-8 relative overflow-hidden">
                    <div className="relative z-10">
                        ...
                        <p className="text-slate-600 text-xs mt-2 font-medium">Total de fondos convertidos exitosamente desde el módulo ARD.</p>
                    </div>
                            ...
                            {collectionDocs.map((doc) => (
                                <tr key={doc.id} className="hover:bg-white/[0.02] transition-colors">
                                    ...
                                    <td className="px-8 py-6">
                                        ...
                                        <div className="text-[10px] font-bold text-slate-600">Fecha Doc: {doc.detected_date}</div>
                                    </td>
                                    <td className="px-8 py-6">
                                    ...
                                    <td className="px-8 py-6 text-center">
                                        {doc.status === 'processed' ? (
                                            ...
                                            <span className="text-slate-700 font-bold text-[10px] uppercase tracking-widest">Finalizado</span>
                                        )}
                                    </td>
                                </tr>
                            ))}
