            ...
            <div className="w-full max-w-4xl bg-slate-900 border border-white/10 rounded-[40px] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 flex flex-col md:flex-row h-[80vh]">
                ...
                <div className="w-full md:w-[380px] flex flex-col bg-slate-900">
                    ...
                    <div className="flex-1 overflow-y-auto p-8 space-y-8 scrollbar-hide">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-white/5 rounded-2xl border border-white/10 flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-[10px] text-slate-600 font-bold">Documento procesado correctamente</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <h4 className="text-[10px] font-black text-slate-600 uppercase tracking-widest">Datos Financieros Detectados</h4>
                            ...
                            <div className="grid grid-cols-1 gap-3">
                                ...
                                <div className="p-4 bg-white/5 rounded-2xl border border-white/10 flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-xs text-slate-500 font-bold">Impuestos (Tax)</span>
                                    </div>
                                ...
                                <div className="p-4 bg-white/5 rounded-2xl border border-white/10 flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-xs text-slate-500 font-bold">Fecha Doc</span>
                                    </div>
                        ...
                        {/* Metadata Extraction */}
                        <div className="space-y-4">
                            <h4 className="text-[10px] font-black text-slate-600 uppercase tracking-widest">Metadatos de Extracción</h4>
