    ...
    return (
        <div className="card-elite !p-0 overflow-hidden">
            <div className="p-6 border-b border-white/5 flex justify-between items-center bg-white/[0.01]">
                ...
                <span className="text-[10px] font-black text-slate-600 uppercase tracking-[0.2em]">{documents.length} DOCUMENTOS</span>
            </div>
                        ...
                        {documents.length === 0 && (
                            <tr>
                                <td colSpan={5} className="px-8 py-20 text-center">
                                    ...
                                    <p className="text-slate-600 font-bold uppercase tracking-widest text-xs">No hay registros en el gestor GAR</p>
                                </td>
                            </tr>
                        )}
                    </tbody>
