...
export const UnifiedAssistant: React.FC<UnifiedAssistantProps> = ({
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-slate-900 rounded-2xl w-full max-w-4xl h-[90vh] flex flex-col shadow-2xl border border-white/10">
                ...
                <div className="flex items-center justify-between p-4 border-b border-white/10">
                    ...
                    <div className="flex items-center space-x-2 bg-white/10 rounded-lg p-1">
                        <button
                            ...
                            className={`flex items-center space-x-2 px-3 py-2 rounded-md transition-colors ${mode === 'dashboard' ? 'bg-blue-600 text-white' : 'text-slate-500 hover:text-white'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center space-x-2 px-3 py-2 rounded-md transition-colors ${mode === 'chat' ? 'bg-blue-600 text-white' : 'text-slate-500 hover:text-white'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center space-x-2 px-3 py-2 rounded-md transition-colors ${mode === 'guide' ? 'bg-blue-600 text-white' : 'text-slate-500 hover:text-white'
                                }`}
                        >
                                        ...
                                        <div className="flex flex-wrap justify-center gap-2">
                                            {['Balance general', 'Productos con stock bajo', 'Impuestos Florida'].map((q) => (
                                                <button
                                                    ...
                                                    className="px-3 py-2 bg-white/10 hover:bg-white/5 text-sm text-white rounded-lg transition-colors"
                                                >
                                                    {q}
                                                </button>
                                            ))}
                            ...
                            <div className="p-4 border-t border-white/10">
                                <div className="flex space-x-2">
                                    ...
                                    <button
                                        ...
                                        className="bg-blue-600 hover:bg-blue-700 disabled:bg-white/5 text-white px-4 py-3 rounded-lg transition-colors"
                                    >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {Object.entries(SYSTEM_GUIDES).map(([key, guide]: [string, { title: string; steps: string[] }]) => (
                                    <button
                                        ...
                                        className="bg-white/10 hover:bg-white/5 p-4 rounded-lg text-left transition-colors border border-white/10"
                                    >
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-slate-500 mt-1">{guide.steps.length} pasos</p>
                                            </div>
                                        </div>
                                    </button>
                                ))}
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                {QUICK_OPERATIONS.map((op: { label: string; guide: string }, i: number) => (
                                    <button
                                        ...
                                        className="bg-white/10 hover:bg-white/5 p-3 rounded-lg text-center transition-colors"
                                    >
