      ...
      <div className="bg-slate-900/50 rounded-2xl shadow-2xl overflow-hidden border border-slate-800 print:bg-white print:text-black print:rounded-none print:shadow-none print:border-none">
        ...
        <div className="bg-slate-950/50 p-8 border-b border-slate-800 print:bg-white print:border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest print:text-slate-600">Fecha de Pago</p>
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-slate-950/30 p-6 rounded-xl border border-slate-800/50 print:bg-gray-50 print:border-gray-200">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-[9px] font-black text-slate-600 uppercase tracking-widest print:text-slate-500">Nombre</p>
                  <p className="text-sm font-black text-white print:text-black">{employee.first_name} {employee.last_name}</p>
                </div>
                <div>
                  <p className="text-[9px] font-black text-slate-600 uppercase tracking-widest print:text-slate-500">ID Empleado</p>
                ...
                <div>
                  <p className="text-[9px] font-black text-slate-600 uppercase tracking-widest print:text-slate-500">Departamento</p>
            ...
            <div className="bg-slate-950/30 p-6 rounded-xl border border-slate-800/50 print:bg-gray-50 print:border-gray-200">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-[9px] font-black text-slate-600 uppercase tracking-widest print:text-slate-500">Tipo de Pago</p>
                ...
                <div>
                  <p className="text-[9px] font-black text-slate-600 uppercase tracking-widest print:text-slate-500">Tasa de Pago</p>
          ...
          <div className="border-t border-slate-800 pt-8 print:border-gray-200">
            <h2 className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-4 print:text-slate-600">RESUMEN ANUAL (YTD)</h2>
