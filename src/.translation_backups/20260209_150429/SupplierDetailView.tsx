      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-slate-900 rounded-lg p-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-500">Condado: {supplier.florida_county}</p>
          </div>
        </div>
        ...
        <div className="bg-slate-900 rounded-lg p-6">
          ...
          <div className="space-y-3">
            ...
            {supplier.assigned_buyer && (
              <div>
                <p className="text-sm text-slate-500">Comprador Asignado</p>
    ...
    <div className="space-y-4">
      ...
      {sampleProducts.length === 0 && (
        <div className="bg-slate-900 rounded-lg p-8 text-center">
          ...
          <p className="text-slate-500">Aún no se han registrado compras a este proveedor.</p>
        </div>
      )}
    </div>
  );
