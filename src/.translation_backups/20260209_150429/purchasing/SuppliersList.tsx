            ...
            <CardContent>
                <div className="border border-white/5 rounded overflow-hidden">
                    <table className="w-full text-sm">
                        <thead className="bg-white/10 text-slate-500 font-medium text-left">
                            <tr>
                        ...
                        <tbody className="divide-y divide-gray-800">
                            {suppliers.map(s => (
                                <tr key={s.id} className="hover:bg-white/10/50">
                                    <td className="p-3 font-medium">{s.name}</td>
                                    <td className="p-3 text-slate-500">{s.contact}</td>
                                    <td className="p-3">
