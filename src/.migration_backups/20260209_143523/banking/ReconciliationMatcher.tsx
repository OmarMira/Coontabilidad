      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600">Transacciones Bancarias</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-purple-600">
              {result.summary.totalAccountingTransactions}
            </div>
            <div className="text-sm text-gray-600">Registros Contables</div>
          </div>
          <div className="text-center">
              ...
              {result.unmatchedAccountingTxs.map(tx => (
                ...
                >
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="font-medium text-sm">{tx.description}</div>
                      <div className="text-xs text-gray-500">{tx.entry_date}</div>
                      <div className="text-xs text-gray-500">Cuenta: {tx.account_code}</div>
                      {tx.reference && (
                        <div className="text-xs text-gray-500">Ref: {tx.reference}</div>
                      )}
                    </div>
