        ...
        <div className="relative p-8 bg-white text-black font-mono text-sm max-w-[210mm] mx-auto border border-gray-300 shadow-lg min-h-[297mm]">
            ...
            <div className="border-b-4 border-black pb-4 mb-6 flex justify-between items-start mt-8">
                <div>
                    ...
                    <h2 className="text-lg text-gray-600">Declaración de Impuestos sobre Ventas y Uso</h2>
                </div>
                <div className="text-right">
                    <div className="bg-gray-100 p-2 rounded border border-gray-300">
                        <p className="text-xs text-gray-500 uppercase">Período de Recaudación</p>
            ...
            <div className="mb-8 grid grid-cols-2 gap-4">
                <div className="border p-2">
                    <p className="text-xs text-gray-500">Número de Certificado</p>
                    <p className="font-bold">{report.taxpayerInfo.fein}</p>
                </div>
                <div className="border p-2">
                    <p className="text-xs text-gray-500">Nombre del Negocio</p>
            ...
            {/* Main Data */}
            <div className="mb-6">
                <h3 className="font-bold bg-black text-white px-2 py-1 mb-2 uppercase">Resumen de Impuestos Adeudados</h3>

                <div className="grid grid-cols-12 gap-2 items-center py-2 border-b border-gray-200">
                    <div className="col-span-8">1. Ventas Brutas</div>
                    <div className="col-span-4 text-right font-bold">{formatCurrency(report.totals.sales)}</div>
                </div>
                <div className="grid grid-cols-12 gap-2 items-center py-2 border-b border-gray-200">
                    <div className="col-span-8">2. Ventas Exentas</div>
                    <div className="col-span-4 text-right">0.00</div>
                </div>
                <div className="grid grid-cols-12 gap-2 items-center py-2 border-b border-gray-200">
                    <div className="col-span-8">3. Ventas Gravables</div>
                ...
                <div className="grid grid-cols-12 gap-2 items-center py-2 border-b border-gray-200 bg-gray-50">
                    <div className="col-span-8 font-bold">4. Total de Impuestos Recaudados</div>
            ...
            <div className="mb-6">
                <h3 className="font-bold bg-gray-200 px-2 py-1 mb-2 uppercase text-xs">Desglose de Recargos por Ventas Discrecionales</h3>
                <table className="w-full text-left text-xs">
                    <thead>
                        <tr className="border-b-2 border-gray-400">
                            <th className="py-1">Condado</th>
                            <th className="py-1 text-right">Monto Gravable</th>
                            <th className="py-1 text-right">Recargo Adeudado</th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div className="mt-auto pt-8 border-t-2 border-black text-xs text-gray-500">
                <div className="flex justify-between items-end">
                    <div>
                        <p className="font-bold uppercase mb-1">Certificación Electrónica</p>
                        <p>Certifico que esta declaración ha sido examinada por mí y que, a mi mejor saber y entender, es una declaración verdadera, correcta y completa.</p>
                    </div>
                    <div className="text-right">
                ...
                <div className="mt-4 font-mono text-[10px] break-all bg-gray-50 p-2 border">
                    SELLO-DIGITAL-IRON-CORE: {report.verification.checksum}
                </div>
                <p className="mt-2 text-center font-bold text-gray-400">SÓLO PARA USO OFICIAL - NO ENVIAR POR CORREO</p>
            </div>
        </div>
    );
};
