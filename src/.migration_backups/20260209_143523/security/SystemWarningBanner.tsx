                ...
                <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3 flex-1">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-yellow-800">
                                Sistema funcionando con {warningChecks.length} advertencia{warningChecks.length > 1 ? 's' : ''}
                            </p>
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="px-3 py-1.5 text-xs font-medium text-yellow-700 hover:text-yellow-900 hover:bg-yellow-100 rounded-md transition-colors flex items-center gap-1.5"
                        >
