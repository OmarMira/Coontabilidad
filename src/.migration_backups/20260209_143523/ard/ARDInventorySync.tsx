            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 p-8 bg-blue-600/5 border border-blue-500/20 rounded-[40px]">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 font-medium text-sm mt-1">Sincronice sus compras y ventas directamente con el stock físico.</p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    return (
                        <div key={doc.id} className="card-elite hover:border-blue-500/30 transition-all group">
                            ...
                            <div className="p-4 bg-black/40 rounded-2xl border border-white/5 space-y-3 mb-6">
                                <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-gray-500 pb-2 border-b border-white/5">
                                    ...
                                    <div className="max-h-32 overflow-y-auto space-y-1 custom-scrollbar">
                                        {allProducts.map(p => (
                                            <button
                                                ...
                                                className="w-full text-left px-3 py-2 rounded-lg hover:bg-white/5 text-[10px] text-gray-400 hover:text-white transition-colors flex justify-between items-center"
                                            >
                ...
                {syncableDocs.length === 0 && (
                    <div className="col-span-2 py-20 text-center card-elite border-dashed border-2 opacity-50">
                        ...
                        <p className="text-gray-500 font-black uppercase tracking-[0.2em] text-xs">No hay productos pendientes de sincronización</p>
                    </div>
                )}
            </div>
        </div>
