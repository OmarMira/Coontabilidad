            ...
            <div className="w-full max-w-4xl bg-slate-900 border border-white/10 rounded-[40px] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 flex flex-col md:flex-row h-[80vh]">
                ...
                <div className="flex-1 bg-black/40 flex flex-col items-center justify-center p-12 border-r border-white/5 relative">
                    <div className="absolute top-6 left-6 flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Vista Previa Forense</span>
                    </div>
                    ...
                    <div className="w-full max-w-md aspect-[3/4] bg-white/5 rounded-2xl border border-white/10 flex flex-col items-center justify-center text-center shadow-2xl relative overflow-hidden group">
                        ...
                        <p className="text-gray-500 font-bold text-xs uppercase tracking-widest px-8">
                            {document.name}
                        </p>
                        <div className="mt-4 px-4 py-1.5 bg-white/5 rounded-full border border-white/10 text-[9px] text-gray-400 font-bold uppercase">
                            {document.type === 'invoice_in' ? 'Factura Recibida' : 'Recibo / Ticket'}
                        </div>
                ...
                <div className="w-full md:w-[380px] flex flex-col bg-slate-900">
                    <div className="p-8 border-b border-white/5 flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="text-lg font-black text-white">Detección IA</h3>
                        </div>
                    ...
                    <div className="flex-1 overflow-y-auto p-8 space-y-8 scrollbar-hide">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-white/5 rounded-2xl border border-white/10 flex items-center gap-4">
                                ...
                                <div>
                                    <div className="text-xs font-black text-white uppercase">Integridad Verificada</div>
                                    <div className="text-[10px] text-gray-500 font-bold">Documento procesado correctamente</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <h4 className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Datos Financieros Detectados</h4>

                            <div className="grid grid-cols-1 gap-3">
                                <div className="p-4 bg-white/5 rounded-2xl border border-white/10 flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        <DollarSign className="w-4 h-4 text-indigo-400" />
                                        <span className="text-xs text-gray-400 font-bold">Monto Total</span>
                                    </div>
                                ...
                                <div className="p-4 bg-white/5 rounded-2xl border border-white/10 flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-xs text-gray-400 font-bold">Impuestos (Tax)</span>
                                    </div>
                                ...
                                <div className="p-4 bg-white/5 rounded-2xl border border-white/10 flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-xs text-gray-400 font-bold">Fecha Doc</span>
                                    </div>
                        ...
                        {/* Metadata Extraction */}
                        <div className="space-y-4">
                            <h4 className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Metadatos de Extracción</h4>
