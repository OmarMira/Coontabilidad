            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div className="flex items-center gap-6">
                    <div className="text-right">
                        <div className="text-[10px] font-black text-gray-500 uppercase tracking-widest leading-none">Clientes Activos ARD</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    ...
                    <div key={client.id} className="card-elite hover:border-indigo-500/30 transition-all group overflow-hidden">
                        <div className="p-6 border-b border-white/5 flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest">ID: {client.id.toString().padStart(4, '0')}</p>
                                </div>
                            </div>
                        ...
                        <div className="p-6 grid grid-cols-2 gap-4 bg-white/[0.01]">
                            <div className="space-y-1">
                                <span className="text-[9px] font-black text-gray-600 uppercase tracking-widest block">Docs Totales</span>
                            ...
                            <div className="space-y-1">
                                <span className="text-[9px] font-black text-gray-600 uppercase tracking-widest block">Liquidez Bruta</span>
                        ...
                        <div className="p-4 bg-black/20 flex items-center justify-between">
                            <div className="flex gap-4">
                                <div className="flex items-center gap-1.5" title="Pendientes de Conversión">
                                    ...
                                    <span className="text-[10px] font-black text-gray-400">{client.pending_conversion}</span>
                                </div>
                                <div className="flex items-center gap-1.5" title="Convertidos">
                                    <div className="w-1.5 h-1.5 rounded-full bg-emerald-500"></div>
                                    <span className="text-[10px] font-black text-gray-400">{client.total_converted}</span>
                                </div>
                            </div>
                ...
                {summaries.length === 0 && (
                    <div className="col-span-full py-20 text-center card-elite border-dashed border-2 border-white/5 opacity-50">
                        ...
                        <p className="text-gray-500 font-black uppercase tracking-[0.2em] text-xs">No hay clientes vinculados a documentos ARD aún</p>
                        <p className="text-gray-600 text-[10px] font-bold mt-2 italic">Asigne clientes a sus escaneos en la pestaña GESTIÓN GAR</p>
                    </div>
                )}
            </div>
        </div>
