/**
 * SCRIPT DE INSERCIÃ“N DE DATOS DE PRUEBA DR-15
 * 
 ...
 * 3. Copiar y pegar este cÃ³digo en la consola
 * 4. Ejecutar: await insertDR15TestData()
 */

async function insertDR15TestData() {
    console.log('ðŸš€ Iniciando inserciÃ³n de datos de prueba DR-15...');

    try {
        // Importar funciones de base de datos
        const { addCustomer } = await import('../modules/db-customers');
        const { createInvoice } = await import('../modules/db-invoices');
        ...
        console.log(`âœ… Clientes creados: ${customer1}, ${customer2}, ${customer3}`);

        // ================================================================
        // PASO 2: CREAR FACTURAS - ENERO 2026
        // ================================================================

        console.log('ðŸ“„ Creando facturas de Enero 2026...');
        ...
        const invoicesEnero = [
            ...
            // Palm Beach
            { customer_id: customer3, invoice_number: 'INV-2026-008', issue_date: '2026-01-10', subtotal: 3400.00, tax_amount: 204.00, notes: 'ColecciÃ³n primavera-verano' },
            { customer_id: customer3, invoice_number: 'INV-2026-009', issue_date: '2026-01-20', subtotal: 2100.00, tax_amount: 126.00, notes: 'Bolsos y zapatos de diseÃ±ador' }
        ];
        ...
        console.log(`âœ… ${invoicesEnero.length} facturas de Enero creadas`);

        // ================================================================
        // PASO 3: CREAR FACTURAS - FEBRERO 2026
        // ================================================================

        console.log('ðŸ“„ Creando facturas de Febrero 2026...');

        const invoicesFebrero = [
            // Miami-Dade
            { customer_id: customer1, invoice_number: 'INV-2026-010', issue_date: '2026-02-14', subtotal: 6200.00, tax_amount: 403.00, notes: 'Cena San ValentÃ­n - MenÃº especial' },
            ...
            // Broward
            { customer_id: customer2, invoice_number: 'INV-2026-013', issue_date: '2026-02-05', subtotal: 4200.00, tax_amount: 252.00, notes: 'Impresoras y escÃ¡neres' },
            ...
            // Palm Beach
            { customer_id: customer3, invoice_number: 'INV-2026-015', issue_date: '2026-02-12', subtotal: 5100.00, tax_amount: 306.00, notes: 'Nueva colecciÃ³n resort wear' },
            { customer_id: customer3, invoice_number: 'INV-2026-016', issue_date: '2026-02-25', subtotal: 1900.00, tax_amount: 114.00, notes: 'JoyerÃ­a y accesorios' }
        ];
        ...
        console.log(`âœ… ${invoicesFebrero.length} facturas de Febrero creadas`);

        // ================================================================
        // PASO 4: CREAR FACTURAS - MARZO 2026
        // ================================================================

        console.log('ðŸ“„ Creando facturas de Marzo 2026...');
        ...
        const invoicesMarzo = [
            ...
            // Broward
            { customer_id: customer2, invoice_number: 'INV-2026-019', issue_date: '2026-03-10', subtotal: 8900.00, tax_amount: 534.00, notes: 'RenovaciÃ³n completa de equipos' },
            { customer_id: customer2, invoice_number: 'INV-2026-020', issue_date: '2026-03-25', subtotal: 1500.00, tax_amount: 90.00, notes: 'InstalaciÃ³n y configuraciÃ³n' },

            // Palm Beach
            { customer_id: customer3, invoice_number: 'INV-2026-021', issue_date: '2026-03-08', subtotal: 6800.00, tax_amount: 408.00, notes: 'ColecciÃ³n exclusiva primavera' },
        ...
        console.log(`âœ… ${invoicesMarzo.length} facturas de Marzo creadas`);
        ...
        console.log('âœ… 22 Facturas creadas (9 Enero + 7 Febrero + 6 Marzo)');
        console.log('\nðŸ’° TOTALES ESPERADOS POR MES:');
        ...
        console.log('\nðŸŽ¯ TOTAL 3 MESES: $83,940.00 subtotal, $5,218.15 tax');
        console.log('\nâœ… Datos de prueba DR-15 insertados correctamente!');
        ...
        console.error('âŒ Error insertando datos de prueba:', error);
        throw error;
    }
}
...
if (typeof window !== 'undefined') {
    ...
    console.log('âœ… FunciÃ³n insertDR15TestData() disponible en consola');
    console.log('ðŸ’¡ Ejecutar: await insertDR15TestData()');
}
